...
export const SelectGroup: FC<ComponentProps<typeof Group>> = props => (
  <Group data-slot="select-group" {...props} />
)

export const SelectValue: FC<ComponentProps<typeof Value>> = props => (
...
export const SelectContent: FC<ComponentProps<typeof Content>> = ({
  className,
  children,
  position = "popper",
  ...props
...
export const SelectLabel: FC<ComponentProps<typeof Label>> = ({
  className,
  ...props
}) => {
  return (
...
export const SelectItem: FC<ComponentProps<typeof Item>> = ({
  className,
  children,
  ...props
}) => {
...
export const SelectSeparator: FC<ComponentProps<typeof Separator>> = ({
  className,
  ...props
}) => {
  return (
